...
SET DCCPATH=C:\Program Files\Embarcadero\RAD Studio\19.0\bin\

rem Path to project Dir
SET PROJECTPATH=C:\Program Files\Devart\UniDAC for RAD Studio 10.2\Demos\ThirdParty\FastReport\FR4\Delphi25\

rem FastReport 4 LibD25 Path
SET FRLIBDLLPATH=C:\Program Files\FastReports\FastReport 4\LibD25
