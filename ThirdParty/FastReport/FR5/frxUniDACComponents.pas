...
function TfrxUniDACDatabase.GetSpecificOptions: TSpecificOptionsList;
begin
  Result := TUniConnection(FDatabase).SpecificOptions;
end;

procedure TfrxUniDACDatabase.SetSpecificOptions(Value: TSpecificOptionsList);
begin
...
function TfrxUniDACTable.GetSpecificOptions: TSpecificOptionsList;
begin
  Result := FTable.SpecificOptions;
end;

procedure TfrxUniDACTable.SetSpecificOptions(Value: TSpecificOptionsList);
begin
...
function TfrxUniDACQuery.GetSpecificOptions: TSpecificOptionsList;
begin
  Result := (FQuery as TCustomUniDataSet).SpecificOptions;
end;

procedure TfrxUniDACQuery.SetSpecificOptions(Value: TSpecificOptionsList);
begin
