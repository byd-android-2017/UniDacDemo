...
type
  ...
  protected
    ...
    /// <summary>
    /// should return DAC product specific connection (i.e. OraSession, MyConnection)
    /// </summary>
    function GetConnection: TCustomDAConnection; virtual; abstract;

    /// <summary>
    /// should return DAC product specific title
    /// </summary>
    ...
    /// </summary>
    function ProductName: string; virtual; abstract;


    /// <summary>
    /// should regiter DAC product specific demos
    /// </summary>
    procedure RegisterDemos; virtual; abstract;
...
{$ENDIF}
    ...
    /// <summary>
    /// should return DAC product specific color
    /// </summary>
    function ProductColor: TColor; virtual; abstract;
...
begin
  ...
  if (ActiveNode <> nil) then
    with Demos.SelectDemo(ActiveNode.AbsoluteIndex) do
    begin
